...
### Примечание
При запуске в ipython-notebook желательно подключать reserfors.py как модуль, иначе стоит запускать непосредственно саму программу. Это необходимо для корректного показа графиков.
